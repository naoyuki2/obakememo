...
<template>
  ...
  <div class="main">
    <div class="flex-container">
      <div
        class="show-range-button"
        @click="getObakeList(-1, 'all_button')"
        v-bind:class="{
          'select-valid-button': selectButtonValid === 'all_button',
        }"
      >
        全表示
      </div>
      <div
        class="show-range-button"
        @click="getObakeList(0, 'today_button')"
        v-bind:class="{
          'select-valid-button': selectButtonValid === 'today_button',
        }"
      >
        本日
      </div>
      <div
        class="show-range-button"
        @click="getObakeList(7, 'week_button')"
        v-bind:class="{
          'select-valid-button': selectButtonValid === 'week_button',
        }"
      >
        1週間
      </div>
      <div
        class="show-range-button"
        @click="getObakeList(31, 'month_button')"
        v-bind:class="{
          'select-valid-button': selectButtonValid === 'month_button',
        }"
      >
        1ヵ月
      </div>
